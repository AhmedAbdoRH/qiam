            ...
            {!editMode && (
              <>
                <button
                  ...
                  title="اتصال"
                  className={`p-1 rounded-md transition-all ${card.contact_phone ? "text-white/45 hover:text-white/80 hover:bg-white/10" : "text-white/15 cursor-not-allowed"}`}
                >
                ...
                <button
                  ...
                  disabled={!card.contact_phone}
                  title="WhatsApp"
                  className={`p-1 rounded-md transition-all ${card.contact_phone ? "text-green-300/55 hover:text-green-300 hover:bg-green-500/10" : "text-white/15 cursor-not-allowed"}`}
                >
                ...
                <button
                  ...
                  title="Messenger"
                  className={`p-1 rounded-md transition-all ${card.contact_messenger ? "text-blue-300/55 hover:text-blue-300 hover:bg-blue-500/10" : "text-white/15 cursor-not-allowed"}`}
                >
