                            ...
                            {Object.entries(CHAT_THEMES).map(([themeKey, theme]) => (
                              ...
                              >
                                <div
                                  ...
                                  style={{ backgroundColor: THEME_ACCENT_COLORS[themeKey as keyof typeof CHAT_THEMES] }}
                                />
                    ...
                    <div className="flex items-center justify-center gap-2 mb-2">
                      ...
                      <div dir="ltr" className="relative flex items-center justify-center bg-white/5 backdrop-blur-md rounded-full p-0.5 w-[140px] border border-white/10 select-none shadow-[inset_0_2px_10px_rgba(0,0,0,0.3)]">
                        ...
                        <div
                          ...
                          style={currentSender === 'myself' ? {
                            backgroundColor: THEME_BG_COLORS[currentTheme].replace('0.2)', '0.4)'),
                            borderColor: THEME_ACCENT_COLORS[currentTheme].replace('0.8)', '0.4)'),
                            border: `1px solid ${THEME_ACCENT_COLORS[currentTheme].replace('0.8)', '0.4)')}`,
                            boxShadow: `inset 0 1px 10px ${THEME_BG_COLORS[currentTheme].replace('0.2)', '0.3)')}, 0 0 15px ${THEME_BG_COLORS[currentTheme]}`
                          } : {}}
                        />
                        ...
                        <Popover open={showCapabilitiesMenu} onOpenChange={setShowCapabilitiesMenu}>
                          <PopoverTrigger asChild>
                            <button
                              ...
                              style={currentSender === 'myself' ? { color: THEME_ACCENT_COLORS[currentTheme] } : {}}
                            >
                      ...
                      <button
                        ...
                        className="relative flex items-center justify-center gap-1 h-6 px-2 rounded-full backdrop-blur-md border transition-all duration-500 text-[9px] font-medium max-w-[72px]"
                        style={{
                      ...
                      >
                        <div
                          ...
                          style={{ backgroundColor: THEME_ACCENT_COLORS[currentTheme] }}
                        />
                        <span className="truncate">{CHAT_THEMES[currentTheme].name}</span>
                      </button>
                      <div className="w-6" />
                    </div>
