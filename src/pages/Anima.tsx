...
const defaultCards: AnimaCard[] = [
  { id: "1", emoji: "💗", title: "الحب الذاتي", description: "", order_index: 0 },
  { id: "2", emoji: "🌸", title: "الحنان", description: "", order_index: 1 },
  { id: "3", emoji: "✨", title: "الإلهام", description: "", order_index: 2 },
  { id: "4", emoji: "🌙", title: "الحدس", description: "", order_index: 3 },
];
